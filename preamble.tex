...
%
\newcommand{\ContentSizeLeft}{\footnotesize}    % left box body text       (8 pt)
\newcommand{\ContentSizeRight}{\footnotesize}   % right box body text      (8 pt)
\newcommand{\HeadingSize}{\small\bfseries}      % subsection headings      (9 pt bold)
\newcommand{\SecondarySize}{\footnotesize}      % dates, orgs, locations   (8 pt)
...
%
% The file is only written during the first pass. On subsequent passes
% (when layout.py has already generated canvas.tex), the heights are
% still logged but layout.py only reads them when invoked.
% ============================================================================
