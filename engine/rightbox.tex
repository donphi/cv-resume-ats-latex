...
\newcommand{\RightBox}[2]{%
    ...
    \pgfmathtruncatemacro{\bodyRows}{\RightBoxPadTop + \contentRows + \RightBoxPadBot}%
    ...
    \typeout{RIGHTBOX [\detokenize{#1}]: rawPt=\rawHeightPt, contentRows=\contentRows, bodyRows=\bodyRows, boxHeight=\boxHeight}%
    ...
    \begin{textblock}{\RightBoxWidth}(\RightPosX,\RightPosY)%
        ...
        \vbox to \BorderRowHeight{\vss\hbox{{\RSL┌─·} \textbf{#1} {\RSL·\Repeat{\dashCount}{─}}{\RDL╖}}\vss}%
        % Body rows (dot-filled)
        \foreach \n in {1,...,\bodyRows}{%
            \vbox to \TPVertModule{\vss\hbox{{\RSL│}{\RDOT\Repeat{\innerW}{·}}{\RDL║}}\vss}%
        }%
        % Bottom border
        \vbox to \BorderRowHeight{\vss\hbox{{\RDL╘\Repeat{\innerW}{═}╝}}\vss}%
    \end{textblock}%
    %
    % =========================================================================
    ...
    \pgfmathsetmacro{\bgY}{\RightPosY + \BorderRowGrid + 1}%
    ...
    \pgfmathsetmacro{\contentY}{\RightPosY + \BorderRowGrid + \RightBoxPadTop}%
